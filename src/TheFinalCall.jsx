...
function getCutoff(college, branch, category) {
  const override = CUTOFF_OVERRIDES[college]?.[branch]?.[category];
  if (override !== undefined) return override;
  return RAW_DATA[college]?.[branch]?.[category];
}
...
@keyframes tfc-settleIn {
  0% { opacity: 0; transform: translateY(18px) scale(0.975); filter: blur(3px); }
  62% { opacity: 1; transform: translateY(-2px) scale(1.004); filter: blur(0); }
  100% { opacity: 1; transform: translateY(0) scale(1); filter: blur(0); }
}
@keyframes tfc-safeHalo {
  0% { box-shadow: 0 10px 30px rgba(42,38,32,0.06), 0 0 0 0 rgba(45,106,79,0); }
  45% { box-shadow: 0 14px 38px rgba(42,38,32,0.08), 0 0 0 9px rgba(45,106,79,0.10); }
  100% { box-shadow: 0 10px 30px rgba(42,38,32,0.06), 0 0 0 0 rgba(45,106,79,0); }
}
@keyframes tfc-cautionHalo {
  0% { box-shadow: 0 10px 30px rgba(42,38,32,0.06), 0 0 0 0 rgba(201,154,46,0); }
  50% { box-shadow: 0 14px 38px rgba(42,38,32,0.08), 0 0 0 8px rgba(201,154,46,0.11); }
  100% { box-shadow: 0 10px 30px rgba(42,38,32,0.06), 0 0 0 0 rgba(201,154,46,0); }
}
@keyframes tfc-dangerEnter {
  0% { opacity: 0; transform: translateY(14px) translateX(0) scale(0.982); }
  45% { opacity: 1; transform: translateY(0) translateX(-2px) scale(1); }
  66% { transform: translateX(2px); }
  82% { transform: translateX(-1px); }
  100% { transform: translateX(0); }
}
@keyframes tfc-badgePop {
  0% { opacity: 0; transform: translateY(10px) scale(0.84); filter: blur(2px); }
  62% { opacity: 1; transform: translateY(-2px) scale(1.055); filter: blur(0); }
  100% { opacity: 1; transform: translateY(0) scale(1); filter: blur(0); }
}
@keyframes tfc-stageUp {
  0% { opacity: 0; transform: translateY(10px); filter: blur(2px); }
  100% { opacity: 1; transform: translateY(0); filter: blur(0); }
}
@keyframes tfc-numberFocus {
  0% { opacity: 0.35; transform: translateY(5px) scale(0.98); }
  60% { opacity: 1; transform: translateY(-1px) scale(1.015); }
  100% { opacity: 1; transform: translateY(0) scale(1); }
}
@keyframes tfc-markerTravel {
  0% { left: 50%; transform: translateX(-50%) scaleY(0.8); opacity: 0.45; }
  65% { left: var(--tfc-marker-left); transform: translateX(-50%) scaleY(1.12); opacity: 1; }
  100% { left: var(--tfc-marker-left); transform: translateX(-50%) scaleY(1); opacity: 1; }
}
@keyframes tfc-gaugeGrow {
  0% { transform: scaleX(0); opacity: 0.35; }
  100% { transform: scaleX(1); opacity: 1; }
}
@keyframes tfc-cardSheen {
  0% { transform: translateX(-145%) skewX(-18deg); opacity: 0; }
  18% { opacity: 0.45; }
  58% { opacity: 0.16; }
  100% { transform: translateX(190%) skewX(-18deg); opacity: 0; }
}
@keyframes tfc-warningShimmer {
...
@keyframes tfc-atmosphereDrift {
  ...
  45% { transform: translate3d(2%, 1%, 0) scale(1.035); }
  100% { transform: translate3d(-0.5%, 2%, 0) scale(1.015); }
}
@keyframes tfc-atmosphereBreath {
  0%, 100% { opacity: 0.38; transform: scale(1); }
  50% { opacity: 0.66; transform: scale(1.015); }
}
@keyframes tfc-waveReveal {
  0% { opacity: 0; transform: translate3d(0, 22%, 0) scale(0.72); }
  55% { opacity: 0.72; }
  100% { opacity: 0; transform: translate3d(0, -8%, 0) scale(1.42); }
}
@keyframes tfc-buttonSweep {
  0% { transform: translateX(-130%) skewX(-22deg); }
  100% { transform: translateX(220%) skewX(-22deg); }
}
@keyframes tfc-dotBounce {
  0%, 80%, 100% { transform: translateY(0); opacity: 0.45; }
  40% { transform: translateY(-4px); opacity: 1; }
}
@keyframes tfc-resultLine {
...
.tfc-result-card {
  position: relative;
  overflow: hidden;
  box-shadow: 0 10px 30px rgba(42,38,32,0.06);
}
.tfc-result-card::before {
  content: "";
  position: absolute;
  top: -35%;
  bottom: -35%;
  ...
  animation: tfc-cardSheen 1.35s cubic-bezier(0.22,1,0.36,1) 0.34s 1 both;
}
.tfc-result-card::after {
  content: "";
  position: absolute;
  ...
  animation: tfc-resultLine 1s ease-out 0.55s both;
  opacity: 0.45;
}
.tfc-card-strong { animation: tfc-settleIn 0.6s cubic-bezier(0.22,1,0.36,1), tfc-safeHalo 1.8s ease-in-out 0.62s 2; }
.tfc-card-realistic { animation: tfc-settleIn 0.6s cubic-bezier(0.22,1,0.36,1), tfc-safeHalo 1.65s ease-in-out 0.62s 1; }
.tfc-card-borderline { animation: tfc-settleIn 0.6s cubic-bezier(0.22,1,0.36,1), tfc-cautionHalo 1.8s ease-in-out 0.62s 2; }
.tfc-card-slim { animation: tfc-dangerEnter 0.72s cubic-bezier(0.22,1,0.36,1); }
.tfc-card-impossible { animation: tfc-dangerEnter 0.78s cubic-bezier(0.22,1,0.36,1); }
.tfc-card-borderline .tfc-warning-layer,
.tfc-card-slim .tfc-warning-layer,
.tfc-card-impossible .tfc-warning-layer {
  display: block;
}
.tfc-warning-layer {
  display: none;
...
.tfc-warning-layer::after {
  content: "";
  position: absolute;
  top: -30%; bottom: -30%; left: -28%; width: 18%;
  background: linear-gradient(90deg, transparent, rgba(255,255,255,0.48), transparent);
  animation: tfc-warningShimmer 1.25s ease-out 0.72s 1 both;
}
.tfc-stage { opacity: 0; animation: tfc-stageUp 0.52s cubic-bezier(0.22,1,0.36,1) forwards; }
.tfc-stage-rank { animation-delay: 0.10s; }
.tfc-stage-cutoff { animation-delay: 0.23s; }
.tfc-stage-gauge { animation-delay: 0.42s; }
.tfc-stage-margin { animation-delay: 0.58s; }
.tfc-stage-prob { animation-delay: 0.73s; }
.tfc-stage-verdict { animation-delay: 0.88s; }
.tfc-number-anim {
  display: inline-block;
  min-width: 1ch;
  font-variant-numeric: tabular-nums;
  animation: tfc-numberFocus 0.78s ease-out both;
}
.tfc-gauge-progress {
  position: absolute;
  top: 0;
  bottom: 0;
  background: var(--tfc-gauge-color);
  border-radius: 4px;
  transform: scaleX(0);
  animation: tfc-gaugeGrow 0.92s cubic-bezier(0.22,1,0.36,1) 0.46s forwards;
}
.tfc-gauge-marker {
  position: absolute;
  top: -4px;
  ...
  animation: tfc-markerTravel 1.02s cubic-bezier(0.22,1,0.36,1) 0.43s forwards;
}
.tfc-badge-anim { animation: tfc-badgePop 0.68s cubic-bezier(0.22,1,0.36,1) 0.92s both; }
.tfc-check-btn {
  position: relative;
  overflow: hidden;
  min-width: 138px;
}
.tfc-check-btn.tfc-checking::after {
  content: "";
  position: absolute;
  top: -50%; bottom: -50%; left: -35%; width: 28%;
  background: linear-gradient(90deg, transparent, rgba(255,255,255,0.38), transparent);
  animation: tfc-buttonSweep 0.78s ease-in-out infinite;
}
.tfc-loading-dots { display: inline-flex; gap: 3px; margin-left: 7px; vertical-align: middle; }
.tfc-loading-dots span { width: 3px; height: 3px; border-radius: 50%; background: currentColor; animation: tfc-dotBounce 0.8s ease-in-out infinite; }
.tfc-loading-dots span:nth-child(2) { animation-delay: 0.12s; }
.tfc-loading-dots span:nth-child(3) { animation-delay: 0.24s; }
...
.tfc-page::before {
  background:
    radial-gradient(circle at 10% 10%, var(--tfc-glow-a, transparent) 0, transparent 31%),
    radial-gradient(circle at 88% 22%, var(--tfc-glow-b, transparent) 0, transparent 29%),
    radial-gradient(circle at 58% 86%, var(--tfc-glow-c, transparent) 0, transparent 36%);
}
.tfc-page::after {
  inset: 0;
  background:
    linear-gradient(115deg, transparent 18%, var(--tfc-sheen, transparent) 48%, transparent 76%),
    radial-gradient(circle at 50% 42%, transparent 0, rgba(247,244,234,0.22) 74%);
}
.tfc-page.tfc-has-result::before { opacity: 1; animation: tfc-atmosphereDrift 14s ease-in-out infinite alternate; }
.tfc-page.tfc-has-result::after { opacity: 1; animation: tfc-atmosphereBreath 6.2s ease-in-out infinite; }
.tfc-result-wave {
  position: absolute;
  z-index: 0;
  pointer-events: none;
  left: 4%; right: 4%; top: 24%; height: 52%;
  border-radius: 50%;
  opacity: 0;
  background: radial-gradient(ellipse at center, var(--tfc-wave, transparent) 0%, transparent 66%);
}
.tfc-has-result .tfc-result-wave { animation: tfc-waveReveal 1.45s cubic-bezier(0.22,1,0.36,1) both; }
.tfc-page-inner { position: relative; z-index: 1; }
.tfc-bg-strong,
.tfc-bg-realistic {
  --tfc-glow-a: rgba(45,106,79,0.19);
  --tfc-glow-b: rgba(116,161,46,0.14);
  --tfc-glow-c: rgba(57,128,86,0.11);
  --tfc-sheen: rgba(105,154,103,0.08);
  --tfc-wave: rgba(82,151,102,0.22);
}
.tfc-bg-borderline {
  --tfc-glow-a: rgba(201,154,46,0.20);
  --tfc-glow-b: rgba(224,178,73,0.13);
  --tfc-glow-c: rgba(180,132,36,0.10);
  --tfc-sheen: rgba(214,166,56,0.08);
  --tfc-wave: rgba(214,166,56,0.23);
}
.tfc-bg-slim {
  --tfc-glow-a: rgba(209,107,63,0.20);
  --tfc-glow-b: rgba(222,139,58,0.13);
  --tfc-glow-c: rgba(190,86,46,0.10);
  --tfc-sheen: rgba(211,115,61,0.08);
  --tfc-wave: rgba(219,123,61,0.23);
}
.tfc-bg-impossible {
  --tfc-glow-a: rgba(179,64,47,0.19);
  --tfc-glow-b: rgba(209,107,63,0.12);
  --tfc-glow-c: rgba(153,50,43,0.10);
  --tfc-sheen: rgba(181,70,53,0.075);
  --tfc-wave: rgba(181,70,53,0.22);
}
.tfc-bg-neutral {
  ...
  --tfc-wave: rgba(140,133,115,0.10);
}

/* ===== High-scale visual scene ===== */
@keyframes tfc-auroraOne {
  0% { transform: translate3d(-8%, -4%, 0) rotate(-7deg) scale(0.95); }
  38% { transform: translate3d(8%, 5%, 0) rotate(5deg) scale(1.08); }
  72% { transform: translate3d(-1%, 10%, 0) rotate(11deg) scale(1.02); }
  100% { transform: translate3d(-8%, -4%, 0) rotate(-7deg) scale(0.95); }
}
@keyframes tfc-auroraTwo {
  0% { transform: translate3d(7%, 8%, 0) rotate(8deg) scale(1.04); }
  50% { transform: translate3d(-10%, -2%, 0) rotate(-9deg) scale(0.94); }
  100% { transform: translate3d(7%, 8%, 0) rotate(8deg) scale(1.04); }
}
@keyframes tfc-gridMove {
  0% { transform: perspective(680px) rotateX(64deg) translateY(15%) translateX(0); opacity: 0.12; }
  50% { opacity: 0.24; }
  100% { transform: perspective(680px) rotateX(64deg) translateY(2%) translateX(-34px); opacity: 0.12; }
}
@keyframes tfc-particleFloat {
  0% { transform: translate3d(0, 28px, 0) scale(0.75); opacity: 0; }
  14% { opacity: var(--particle-opacity, .55); }
  58% { transform: translate3d(var(--particle-drift, 20px), -56px, 0) scale(1); opacity: var(--particle-opacity, .55); }
  100% { transform: translate3d(calc(var(--particle-drift, 20px) * -0.35), -128px, 0) scale(0.55); opacity: 0; }
}
@keyframes tfc-orbitSpin {
  from { transform: translate(-50%, -50%) rotate(0deg); }
  to { transform: translate(-50%, -50%) rotate(360deg); }
}
@keyframes tfc-orbitSpinReverse {
  from { transform: translate(-50%, -50%) rotate(360deg); }
  to { transform: translate(-50%, -50%) rotate(0deg); }
}
@keyframes tfc-portalFlash {
  0% { opacity: 0; transform: scale(.82); }
  35% { opacity: .92; }
  100% { opacity: 0; transform: scale(1.34); }
}
@keyframes tfc-rayBurst {
  0% { opacity: 0; transform: rotate(var(--ray-angle)) translateX(0) scaleX(.2); }
  34% { opacity: .85; }
  100% { opacity: 0; transform: rotate(var(--ray-angle)) translateX(78px) scaleX(1.35); }
}
@keyframes tfc-cardFloat {
  0%,100% { transform: translateY(0); }
  50% { transform: translateY(-3px); }
}
@keyframes tfc-electricBorder {
  0% { transform: rotate(0deg); opacity: .45; }
  50% { opacity: .9; }
  100% { transform: rotate(360deg); opacity: .45; }
}
@keyframes tfc-gaugeSpark {
  0% { transform: translateX(-18px) scale(.5); opacity: 0; }
  20% { opacity: 1; }
  100% { transform: translateX(28px) scale(1.15); opacity: 0; }
}
@keyframes tfc-statusCore {
  0%,100% { transform: scale(.92); box-shadow: 0 0 0 0 var(--tfc-electric-soft); }
  50% { transform: scale(1.08); box-shadow: 0 0 0 12px transparent; }
}
@keyframes tfc-panelSheen {
  0% { transform: translateX(-160%) skewX(-18deg); opacity: 0; }
  20% { opacity: .24; }
  100% { transform: translateX(230%) skewX(-18deg); opacity: 0; }
}
@keyframes tfc-headingGlow {
  0%,100% { text-shadow: 0 0 0 transparent; }
  50% { text-shadow: 0 0 22px var(--tfc-electric-soft); }
}
...
.tfc-aurora {
  ...
  min-height: 420px;
  border-radius: 50%;
  filter: blur(66px) saturate(115%);
  opacity: 0;
  transition: opacity .9s ease, background .9s ease;
  will-change: transform, opacity;
}
.tfc-has-result .tfc-aurora { opacity: .58; }
.tfc-aurora-a {
  left: -22%; top: -18%;
  background: radial-gradient(circle at 46% 46%, var(--tfc-electric-soft) 0, transparent 62%);
  animation: tfc-auroraOne 13s ease-in-out infinite;
}
.tfc-aurora-b {
  right: -28%; top: 15%;
  background: radial-gradient(circle at 52% 48%, var(--tfc-glow-b) 0, transparent 64%);
  animation: tfc-auroraTwo 16s ease-in-out infinite;
}
.tfc-grid-field {
  position: absolute;
  left: -15%; right: -15%; bottom: -23%; height: 55%;
  opacity: 0;
  background-image:
    linear-gradient(var(--tfc-grid-line) 1px, transparent 1px),
    linear-gradient(90deg, var(--tfc-grid-line) 1px, transparent 1px);
  background-size: 42px 42px;
  mask-image: linear-gradient(to top, #000 0%, rgba(0,0,0,.8) 48%, transparent 100%);
  -webkit-mask-image: linear-gradient(to top, #000 0%, rgba(0,0,0,.8) 48%, transparent 100%);
  transform-origin: bottom center;
}
.tfc-has-result .tfc-grid-field { animation: tfc-gridMove 9s linear infinite alternate; }
.tfc-particle-field { position: absolute; inset: 0; opacity: 0; transition: opacity .7s ease; }
.tfc-has-result .tfc-particle-field { opacity: 1; }
.tfc-particle {
  position: absolute;
  width: var(--particle-size, 4px);
  height: var(--particle-size, 4px);
  border-radius: 50%;
  background: var(--tfc-particle-color);
  box-shadow: 0 0 10px var(--tfc-electric-soft), 0 0 20px var(--tfc-electric-soft);
  animation: tfc-particleFloat var(--particle-duration, 6s) ease-in-out infinite;
...
.tfc-control-panel:hover {
  transform: translateY(-2px);
  box-shadow: 0 14px 34px rgba(42,38,32,.08) !important;
}
.tfc-control-panel::after {
  content: "";
  position: absolute;
  top: -55%; bottom: -55%; left: -30%; width: 18%;
  background: linear-gradient(90deg, transparent, rgba(255,255,255,.66), transparent);
  pointer-events: none;
}
.tfc-control-panel:focus-within::after { animation: tfc-panelSheen 1.15s ease-out 1; }

.tfc-title-live { position: relative; display: inline-block; }
.tfc-has-result .tfc-title-live { animation: tfc-headingGlow 3.4s ease-in-out 1; }
...
.tfc-result-portal::before,
.tfc-result-portal::after {
  content: "";
  position: absolute;
  left: 50%; top: 50%;
...
.tfc-result-portal::before {
  border: 1px solid var(--tfc-electric-soft);
  box-shadow: inset 0 0 70px var(--tfc-electric-soft), 0 0 80px var(--tfc-electric-soft);
  animation: tfc-orbitSpin 18s linear infinite;
}
.tfc-result-portal::after {
  width: min(60vw, 570px);
  border: 1px dashed var(--tfc-electric-soft);
  animation: tfc-orbitSpinReverse 14s linear infinite;
}
.tfc-portal-flash {
  position: absolute;
  left: 50%; top: 50%;
  ...
  border-radius: 50%;
  transform: translate(-50%,-50%);
  background: radial-gradient(circle, var(--tfc-electric-soft) 0, transparent 66%);
  z-index: -1;
  opacity: 0;
  animation: tfc-portalFlash 1.25s cubic-bezier(.22,1,.36,1) .12s 1 both;
}
.tfc-energy-rays {
  position: absolute;
  left: 50%; top: 50%;
...
.tfc-energy-ray {
  ...
  background: linear-gradient(90deg, var(--tfc-electric), transparent);
  opacity: 0;
  animation: tfc-rayBurst 1.05s cubic-bezier(.22,1,.36,1) var(--ray-delay, .12s) 1 both;
}
...
.tfc-result-card > * { position: relative; z-index: 2; }
.tfc-result-card .tfc-warning-layer { z-index: 3; }
.tfc-result-card .tfc-electric-edge {
  position: absolute;
  inset: -46%;
  z-index: 0;
  pointer-events: none;
  background: conic-gradient(from 0deg, transparent 0 24%, var(--tfc-electric-soft) 31%, transparent 39% 62%, var(--tfc-electric-soft) 69%, transparent 77%);
  animation: tfc-electricBorder 8s linear infinite;
}
.tfc-result-card .tfc-inner-glass {
  position: absolute;
  inset: 1px;
  z-index: 1;
  pointer-events: none;
  border-radius: 7px;
  background: linear-gradient(135deg, rgba(255,255,255,.34), transparent 32%, transparent 68%, rgba(255,255,255,.12));
}
.tfc-card-strong,
.tfc-card-realistic { animation: tfc-settleIn .62s cubic-bezier(.22,1,.36,1), tfc-safeHalo 1.8s ease-in-out .62s 2, tfc-cardFloat 5s ease-in-out 2.4s infinite; }
.tfc-card-borderline { animation: tfc-settleIn .62s cubic-bezier(.22,1,.36,1), tfc-cautionHalo 1.8s ease-in-out .62s 2, tfc-cardFloat 5.5s ease-in-out 2.4s infinite; }

.tfc-gauge-track {
  overflow: visible;
}
.tfc-gauge-marker::after {
  content: "";
  position: absolute;
  left: 50%; top: 50%;
  ...
  border-radius: 50%;
  transform: translate(-50%,-50%);
  background: radial-gradient(circle, rgba(255,255,255,.95) 0 8%, var(--tfc-electric-soft) 22%, transparent 68%);
  animation: tfc-statusCore 1.8s ease-in-out 1.4s 2;
}
.tfc-gauge-progress::after {
  content: "";
  position: absolute;
  top: 50%; right: -3px;
  width: 38px; height: 12px;
  transform: translateY(-50%);
  background: radial-gradient(ellipse at center, rgba(255,255,255,.95) 0, var(--tfc-electric-soft) 28%, transparent 70%);
  filter: blur(.5px);
  animation: tfc-gaugeSpark 1s ease-out 1.18s 1 both;
}

.tfc-verdict-orb {
  width: 10px; height: 10px; border-radius: 50%;
  background: #fff;
  box-shadow: 0 0 0 5px rgba(255,255,255,.13), 0 0 18px rgba(255,255,255,.7);
  animation: tfc-statusCore 1.7s ease-in-out 1.25s 3;
}

.tfc-bg-strong,
.tfc-bg-realistic {
  --tfc-electric: #3f9b69;
  --tfc-electric-soft: rgba(63,155,105,.30);
  --tfc-grid-line: rgba(63,155,105,.14);
  --tfc-particle-color: rgba(73,174,119,.72);
}
.tfc-bg-borderline {
  --tfc-electric: #d6a632;
  --tfc-electric-soft: rgba(214,166,50,.30);
  --tfc-grid-line: rgba(214,166,50,.14);
  --tfc-particle-color: rgba(224,178,73,.75);
}
.tfc-bg-slim {
  --tfc-electric: #dd7d42;
  --tfc-electric-soft: rgba(221,125,66,.31);
  --tfc-grid-line: rgba(221,125,66,.14);
  --tfc-particle-color: rgba(232,139,82,.76);
}
.tfc-bg-impossible {
  --tfc-electric: #c65345;
  --tfc-electric-soft: rgba(198,83,69,.30);
  --tfc-grid-line: rgba(198,83,69,.14);
  --tfc-particle-color: rgba(215,91,75,.76);
}
.tfc-bg-neutral {
  --tfc-electric: #8d8779;
  --tfc-electric-soft: rgba(141,135,121,.20);
  --tfc-grid-line: rgba(141,135,121,.10);
  --tfc-particle-color: rgba(141,135,121,.45);
}

@media (prefers-reduced-motion: reduce) {
  .tfc-card-strong, .tfc-card-realistic, .tfc-card-borderline, .tfc-card-slim, .tfc-card-impossible,
  .tfc-badge-anim, .tfc-number-anim, .tfc-stage, .tfc-gauge-progress, .tfc-gauge-marker,
  .tfc-result-card::before, .tfc-result-card::after, .tfc-warning-layer::after,
  .tfc-check-btn.tfc-checking::after, .tfc-loading-dots span,
  .tfc-page.tfc-has-result::before, .tfc-page.tfc-has-result::after, .tfc-has-result .tfc-result-wave,
  .tfc-aurora, .tfc-grid-field, .tfc-particle, .tfc-result-portal::before, .tfc-result-portal::after,
  .tfc-portal-flash, .tfc-energy-ray, .tfc-electric-edge, .tfc-verdict-orb,
  .tfc-gauge-marker::after, .tfc-gauge-progress::after, .tfc-title-live {
    animation: none !important;
  }
  .tfc-stage { opacity: 1 !important; }
  .tfc-gauge-progress { transform: scaleX(1) !important; }
  .tfc-gauge-marker { left: var(--tfc-marker-left) !important; transform: translateX(-50%) !important; }
}
`;
...
function AnimatedNumber({ value, duration = 850, delay = 0 }) {
...
function AnimatedMetric({ value, decimals = 0, prefix = "", suffix = "", duration = 760, delay = 0 }) {
  const [displayValue, setDisplayValue] = useState(0);
  ...
  const rendered = decimals > 0 ? abs.toFixed(decimals) : Math.round(abs).toLocaleString("en-IN");
  const sign = displayValue < -0.00001 ? "−" : prefix;

  return <span className="tfc-number-anim">{sign}{rendered}{suffix}</span>;
}
...
function VisualAtmosphere() {
  return (
    <div className="tfc-visual-scene" aria-hidden="true">
      <div className="tfc-aurora tfc-aurora-a" />
      <div className="tfc-aurora tfc-aurora-b" />
      <div className="tfc-grid-field" />
      <div className="tfc-particle-field">
        {PARTICLES.map((p, i) => (
          <span
            key={i}
            className="tfc-particle"
            style={{
              left: p.left,
              top: p.top,
...
function ResultPortal({ children }) {
  const rays = Array.from({ length: 16 }, (_, i) => i);
  return (
    <div className="tfc-result-portal">
      <div className="tfc-portal-flash" aria-hidden="true" />
      <div className="tfc-energy-rays" aria-hidden="true">
        {rays.map(i => (
          <span
            key={i}
            className="tfc-energy-ray"
            style={{
              "--ray-angle": `${i * 22.5}deg`,
              "--ray-delay": `${0.08 + (i % 4) * 0.045}s`,
            }}
          />
        ))}
      </div>
...
function ResultCard({ college, branch, category, rank }) {
  const cutoff = getCutoff(college, branch, category);
  if (cutoff === undefined) return null;

  if (cutoff === null) {
    return (
      <div className="tfc-result-card" style={{
        border: "1px solid #d8d2c2", borderLeft: "5px solid #9a9284", background: "#f4f1ea",
        borderRadius: 7, padding: "18px 20px", fontFamily: "'IBM Plex Mono', monospace",
      }}>
  ...
  const probValue = Math.max(0.5, Math.min(99, v.prob));

  const clamped = Math.max(-40, Math.min(40, margin));
  const gaugePct = ((clamped + 40) / 80) * 100;
  const gaugeLeft = Math.min(50, gaugePct);
  const gaugeWidth = Math.abs(gaugePct - 50);
  const gaugeOrigin = gaugePct >= 50 ? "left center" : "right center";

  return (
    <div
      className={`tfc-result-card ${VERDICT_CLASS[v.key]}`}
      style={{
        border: `1px solid ${s.border}55`, borderLeft: `6px solid ${s.border}`, background: s.bg,
        borderRadius: 8, padding: "22px 24px", color: s.accent,
      }}
    >
      <span className="tfc-electric-edge" aria-hidden="true" />
      <span className="tfc-inner-glass" aria-hidden="true" />
      <span className="tfc-warning-layer" aria-hidden="true" />

      <div className="tfc-stage tfc-stage-rank" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", flexWrap: "wrap", gap: 8 }}>
      ...
      <div className="tfc-stage tfc-stage-rank" style={{ fontFamily: "'Source Serif Pro', Georgia, serif", fontSize: 13, color: "#5b5648", marginTop: 2, marginBottom: 16 }}>
        {branch}
      </div>

      <div style={{ display: "flex", gap: 24, flexWrap: "wrap", alignItems: "flex-end", marginBottom: 14 }}>
        <div className="tfc-stage tfc-stage-rank">
          ...
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 28, fontWeight: 600, color: "#2a2620" }}>
            <AnimatedNumber value={rank} duration={820} delay={90} />
          </div>
        </div>

        <div className="tfc-stage tfc-stage-cutoff" style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 20, color: "#b3ab94", paddingBottom: 4 }}>vs</div>

        <div className="tfc-stage tfc-stage-cutoff">
          ...
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 28, fontWeight: 600, color: "#2a2620" }}>
            <AnimatedNumber value={cutoff} duration={860} delay={220} />
          </div>
        </div>

        <div className="tfc-stage tfc-stage-margin" style={{ marginLeft: "auto", textAlign: "right" }}>
          ...
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 18, fontWeight: 600, color: s.accent }}>
            <AnimatedMetric value={margin} decimals={1} prefix={margin >= 0 ? "+" : ""} suffix="%" duration={720} delay={560} />
          </div>
        </div>
      </div>

      <div className="tfc-stage tfc-stage-gauge">
        <div className="tfc-gauge-track" style={{ position: "relative", height: 9, background: "#e4ddc9", borderRadius: 5, marginBottom: 7, boxShadow: "inset 0 1px 2px rgba(42,38,32,0.08)" }}>
          <div style={{ position: "absolute", left: "50%", top: -4, bottom: -4, width: 2, background: "#2a2620aa", transform: "translateX(-1px)", zIndex: 2 }} />
          <div
            className="tfc-gauge-progress"
            style={{
              left: `${gaugeLeft}%`, width: `${gaugeWidth}%`,
              transformOrigin: gaugeOrigin,
              "--tfc-gauge-color": s.accent,
            }}
          />
          <div
            className="tfc-gauge-marker"
            style={{
              "--tfc-marker-left": `${gaugePct}%`,
              "--tfc-gauge-color": s.accent,
            }}
          />
        </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
        <div className="tfc-stage tfc-stage-verdict">
          <div className="tfc-badge-anim" style={{
            display: "inline-flex", alignItems: "center", gap: 8, padding: "7px 14px", borderRadius: 4, background: s.accent,
            color: "#fff", fontFamily: "'Source Serif Pro', Georgia, serif", fontWeight: 700, fontSize: 15,
            boxShadow: `0 5px 14px ${s.accent}2b`,
          }}>
            <span className="tfc-verdict-orb" aria-hidden="true" />
            {v.tier}
          </div>
        </div>

        <div className="tfc-stage tfc-stage-prob" style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 13, color: s.text }}>
          Estimated probability: <b><AnimatedMetric value={probValue} decimals={0} suffix="%" duration={760} delay={710} /></b>
        </div>
      </div>
    </div>
  );
...
export default function TheFinalCall() {
  ...
  const suggestions = useMemo(() => {
    ...
    const cur = getCutoff(resultCollege, resultBranch, resultCategory);
    ...
    for (const b of resultBranches) {
      ...
      const c = getCutoff(resultCollege, b, resultCategory);
      if (c == null) continue;
  ...
  const resultTheme = useMemo(() => {
    ...
    const cutoff = getCutoff(submitted.college, submitted.branch, submitted.category);
  ...
  return (
    ...
    >
      ...
      <VisualAtmosphere />
      <div className="tfc-result-wave" aria-hidden="true" />
      ...
      <div className="tfc-page-inner" style={{ maxWidth: 880, margin: "0 auto" }}>
        <div style={{ borderBottom: "3px double #1a2332", paddingBottom: 16, marginBottom: 28 }}>
          ...
          <h1 className="tfc-title-live" style={{ fontSize: 30, fontWeight: 700, margin: 0, letterSpacing: -0.3 }}>The Final Call</h1>
        ...
        <form className="tfc-control-panel" onSubmit={handleSubmit} style={{
          ...
          <div style={{
            ...
            <button
              type="submit"
              className={`tfc-check-btn ${checking ? "tfc-checking" : ""}`}
              disabled={!formReady || checking}
              style={{
                border: "1px solid #1a2332", borderRadius: 5, padding: "11px 19px",
                ...
                cursor: formReady && !checking ? "pointer" : "not-allowed",
                transition: "transform 0.18s ease, background 0.18s ease, box-shadow 0.18s ease",
                boxShadow: formReady ? "0 6px 16px rgba(26,35,50,0.16)" : "none",
              }}
            >
              {checking ? (
                <React.Fragment>
                  Checking
                  <span className="tfc-loading-dots" aria-hidden="true"><span /><span /><span /></span>
                </React.Fragment>
              ) : "Check Result"}
            </button>
          </div>
        ...
        {checking ? (
          <div className="tfc-processing-card" style={{
            fontFamily: "'IBM Plex Mono', monospace", fontSize: 12, color: "#5b5648",
            textAlign: "center", padding: "30px 20px", border: "1px solid #ddd6c4", borderRadius: 7,
            background: "rgba(255,255,255,0.76)", boxShadow: "0 8px 24px rgba(42,38,32,0.05)",
          }}>
            <div style={{ fontFamily: "'Source Serif Pro', Georgia, serif", fontSize: 17, fontWeight: 700, color: "#2a2620", marginBottom: 7 }}>
              Reading your cutoff position
            </div>
            Rank, branch and category are being matched
            <span className="tfc-loading-dots" aria-hidden="true"><span /><span /><span /></span>
          </div>
        ) : !submitted ? (
          <div style={{
